...
AALSAnimManCharacter::AALSAnimManCharacter() {
    // Components
...
void AALSAnimManCharacter::Tick(float DeltaTime) {
...
void AALSAnimManCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent) {
    ...
    PlayerInputComponent->BindAction("MKeyPressed", IE_Pressed, this, &AALSAnimManCharacter::MKeyPressed);
}

// ================================================================================
// IALSCamera
void AALSAnimManCharacter::Get3PTraceParams(FVector& TraceOrigin, float& TraceRadius, TEnumAsByte<ETraceTypeQuery>& TraceChannel) {
    if (RightShoulder) {
...
FTransform AALSAnimManCharacter::Get3PPivotTarget() {
    return FTransform{
        GetActorRotation(),
...
FVector AALSAnimManCharacter::GetFPCameraTarget() {
    return GetMesh()->GetSocketLocation("FP_Camera");
}

// ================================================================================
// Coloring System
void AALSAnimManCharacter::SetDynamicMaterials() {
...
void AALSAnimManCharacter::SetResetColors() {
    if (SolidColor) {
...
void AALSAnimManCharacter::UpdateColoringSystem() {
...
void AALSAnimManCharacter::UpdateLayeringColors() {
...
// ================================================================================
// Held Object
void AALSAnimManCharacter::UpdateHeldObject() {
    switch (OverlayState) {
...
void AALSAnimManCharacter::ClearHeldObject() {
    StaticMesh->SetStaticMesh(nullptr);
    SkeletalMesh->SetSkinnedAssetAndUpdate(nullptr, false);
    SkeletalMesh->SetAnimInstanceClass(nullptr);
}

void AALSAnimManCharacter::AttachToHand(UStaticMesh* NewStaticMesh, USkeletalMesh* NewSkeletalMesh, UClass* NewAnimClass, bool LeftHand, FVector Offset) {
    ClearHeldObject();
    if (NewStaticMesh) {
...
void AALSAnimManCharacter::UpdateHeldObjectAnimations() {
...
// ================================================================================
// State Changes
void AALSAnimManCharacter::OnOverlayStateChanged(EALSOverlayState NewOverlayState) {
...
// ================================================================================
// Movement System
UAnimMontage* AALSAnimManCharacter::GetRollAnimation() {
    switch (OverlayState) {
    case EALSOverlayState::EAOS_Default:
    case EALSOverlayState::EAOS_Masculine:
    case EALSOverlayState::EAOS_Feminine:
...
// ================================================================================
// Mantle System
void AALSAnimManCharacter::MantleStart(float MantleHeight, FALSComponentAndTransform MantleLedgeWS, EMantleType MantleType) {
...
void AALSAnimManCharacter::MantleEnd() {
    Super::MantleEnd();
    UpdateHeldObject();
}

FMantleAsset AALSAnimManCharacter::GetMantleAsset(EMantleType MantleType) {
    if (MantleType == EMantleType::EMT_LowMantle) {
        switch (OverlayState) {
        case EALSOverlayState::EAOS_Default:
        case EALSOverlayState::EAOS_Masculine:
...
// ================================================================================
// Ragdoll System
void AALSAnimManCharacter::RagdollStart() {
    ClearHeldObject();
    Super::RagdollStart();
}

void AALSAnimManCharacter::RagdollEnd() {
    Super::RagdollEnd();
    UpdateHeldObject();
}

UAnimMontage* AALSAnimManCharacter::GetGetUpAnimation(bool InRagdollFaceUp) {
    switch (OverlayState) {
    case EALSOverlayState::EAOS_Default:
    case EALSOverlayState::EAOS_Masculine:
    case EALSOverlayState::EAOS_Feminine:
...
void AALSAnimManCharacter::MKeyPressed() {
